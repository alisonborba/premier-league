...
export const LeagueRow: React.FC<LeagueRowProps> = ({ row, className = '' }) => {
  ...
  return (
    <tr className={`table-row ${getPositionClass(row.position)} ${className}`.trim()}>
      <td className="table-cell table-cell--position">
        {row.position}
      </td>
      ...
      <td className="table-cell table-cell--played">
        {row.played}
      </td>
      <td className="table-cell table-cell--wins">
        {row.wins}
      </td>
      <td className="table-cell table-cell--draws">
        {row.draws}
      </td>
      <td className="table-cell table-cell--losses">
        {row.losses}
      </td>
      <td className="table-cell table-cell--goals-for">
        {row.gf}
      </td>
      <td className="table-cell table-cell--goals-against">
        {row.ga}
      </td>
      <td className="table-cell table-cell--goal-difference">
